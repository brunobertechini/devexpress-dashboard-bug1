...
var Layout = function() {
    ...
    var layoutImgPath = 'layouts/layout1/img/';

    var layoutCssPath = 'layouts/layout1/css/';
...
// TODO Abp/Metronic: Bug de Toggle SideBar sendo chamado duas vezes (Layout.init twice)
// if (App.isAngularJsApp() === false) {
//     jQuery(document).ready(function() { 
//         console.log('calling layout.init from layout1 metronic'); 
